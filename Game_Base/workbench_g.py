    ...
    def bench(self, stdscr): # Цикл рабочего стола
        ...
        while True:
            if cpsh.message_see(self.number_message) == False:
                main_bench_choice = curses.wrapper(lambda stdscr: hlp.main(stdscr, txt.workbench_main, 0, "Your work bench:", 0, 1, True, False, 0)) # Состояние без сообщения
            else:
                main_bench_choice = curses.wrapper(lambda stdscr: hlp.main(stdscr, txt.workbench_main_with_message, 0, "Your work bench:", 0, 1, True, False, 0))# Состояние с сообщением
