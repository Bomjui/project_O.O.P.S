History = {1: "Здравия желаю, я как понял ты новый работник нашей организации O.O.P.S.\nи ближайщие 10 дней ты будешь выполнять задачи что тебе будут приходить."
"Давай я тебе озвучу твои их .\nБудь осторожен ведь кто знает что ты встретишь.",
            2: "", 3: ""}
